...
declare const isMetaMask: () => boolean;
declare const isDawn: () => boolean | undefined;
declare const isCoinbaseWallet: () => boolean;
declare const isFrame: () => boolean;
declare const isPhantom: () => boolean;
...
export { nFormatter, truncateEthAddress, truncateENSAddress, isMobile, isAndroid, detectBrowser, detectOS, getWalletDownloadUri, isMetaMask, isDawn, isCoinbaseWallet, isFrame, isPhantom, flattenChildren, };
