import { configureChains, useQuery, useAccount, useNetwork, useSignMessage, useConnect as useConnect$1, useSwitchNetwork, useEnsAddress, useEnsName, useEnsAvatar, useDisconnect, useBalance } from 'wagmi';
...
const defaultConnectors = ({ chains, app, walletConnectProjectId, }) => {
...
const Family = ({ transparent = false, ...props }) => {
...
const isFamily = () => {
    ...
    if (typeof window === 'undefined')
        return false;
    return (_a = window === null || window === void 0 ? void 0 : window.ethereum) === null || _a === void 0 ? void 0 : _a.isFamily;
};
const isDawn = () => {
    var _a;
    if (typeof window === 'undefined')
        return false;
    return (_a = window === null || window === void 0 ? void 0 : window.ethereum) === null || _a === void 0 ? void 0 : _a.isDawn;
};
const isFrame = () => {
    if (typeof window === 'undefined')
        return false;
...
const isPhantom = () => {
    ...
    return (_a = phantom === null || phantom === void 0 ? void 0 : phantom.ethereum) === null || _a === void 0 ? void 0 : _a.isPhantom;
};
const isInfinityWallet = () => {
    if (typeof window === 'undefined')
        return false;
    const { ethereum } = window;
    return !!((ethereum === null || ethereum === void 0 ? void 0 : ethereum.isInfinityWallet) ||
        ((ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers) &&
            (ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers.find((provider) => provider.isInfinityWallet))));
};
const isRabby = () => {
    if (typeof window === 'undefined')
        return false;
...
const isFrontier = () => {
    ...
    if (typeof window === 'undefined')
        return false;
    const { phantom } = window;
    return (_a = phantom === null || phantom === void 0 ? void 0 : phantom.ethereum) === null || _a === void 0 ? void 0 : _a.isFrontier;
};
const isTrust = () => {
    var _a, _b;
    if (typeof window === 'undefined')
        return false;
    const { ethereum } = window;
    return !!((ethereum === null || ethereum === void 0 ? void 0 : ethereum.isTrust) ||
        ((ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers) &&
            (ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers.find((provider) => provider.isTrust))) ||
        ((_a = window === null || window === void 0 ? void 0 : window.trustWallet) === null || _a === void 0 ? void 0 : _a.isTrust) ||
        ((_b = window === null || window === void 0 ? void 0 : window.trustwallet) === null || _b === void 0 ? void 0 : _b.isTrust));
};
const isTokenPocket = () => {
    var _a;
    if (typeof window === 'undefined')
        return false;
    return (_a = window === null || window === void 0 ? void 0 : window.ethereum) === null || _a === void 0 ? void 0 : _a.isTokenPocket;
};
const isTalisman = () => {
    if (typeof window === 'undefined')
        return false;
    const { talismanEth } = window;
    return !!(talismanEth === null || talismanEth === void 0 ? void 0 : talismanEth.isTalisman);
};
const isFordefi = () => {
    var _a;
    if (typeof window === 'undefined')
        return false;
    return (_a = window === null || window === void 0 ? void 0 : window.ethereum) === null || _a === void 0 ? void 0 : _a.isFordefi;
};
const isRainbow = () => {
    if (typeof window === 'undefined')
        return false;
    const { ethereum } = window;
    return !!((ethereum === null || ethereum === void 0 ? void 0 : ethereum.isRainbow) ||
        ((ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers) &&
            (ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers.find((provider) => provider.isRainbow))));
};
...
const infinityWallet = () => {
    ...
    return {
        ...
        logos: {
            default: jsx(Logos.InfinityWallet, {}),
            mobile: jsx(Logos.InfinityWallet, {}),
            transparent: jsx(Logos.InfinityWallet, {}),
            appIcon: jsx(Logos.InfinityWallet, {}),
            connectorButton: jsx(Logos.InfinityWallet, {}),
        },
...
const rainbow = () => {
    ...
    return {
        ...
        logos: {
            ...
            mobile: jsx(Logos.Rainbow, {}),
            appIcon: jsx(Logos.Rainbow, {}),
            connectorButton: jsx(Logos.Rainbow, { round: true }),
        },
...
const family = () => {
    ...
    return {
        ...
        logos: {
            ...
            transparent: jsx(Logos.Family, { transparent: true }),
        },
...
const phantom = () => {
    ...
    return {
        ...
        scannable: false,
        logos: {
            default: jsx(Logos.Phantom, { background: true }),
            transparent: jsx(Logos.Phantom, {}),
        },
        installed: Boolean(isInstalled),
    };
};
...
function useDefaultWallets() {
    ...
    defaultWallets.push('argent', 'trust', 'ledger', 'infinityWallet', 'family', 'imToken', 'rainbow', 'unstoppable', 'onto', 'steak', 'frontier', 'zerion', 'gnosisSafe', 'brave', 
    //'slope',
    'frame', 'phantom', 'dawn', 'rabby', 'talisman', 'fordefi', 'tokenPocket');
...
const useInjectedWallet = () => {
    ...
    const getWallet = () => {
        ...
        if (installedWallets.length > 0) {
            ...
            return {
                id: 'injected',
                name: (_b = (_a = getInjectedNames()) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : 'Browser Wallet',
                shortName: (_e = (_d = (_c = getInjectedNames()) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.replace(' Wallet', '')) !== null && _e !== void 0 ? _e : 'Browser',
                logos: {
                    default: jsx(Logos.Injected, {}),
                },
            };
...
const Modal = ({ open, pages, pageId, positionInside, inline, demo, onClose, onBack, onInfo, }) => {
    ...
    const wallets = useDefaultWallets();
    const installedWallets = wallets.filter((wallet) => wallet.installed);
    let connector = supportedConnectors$1.find((c) => c.id === context.connector);
    ...
    if (isInjectedConnector(context.connector)) {
        ...
        connector = {
            ...
            extensions: {
                ...wallet === null || wallet === void 0 ? void 0 : wallet.downloadUrls,
            },
            appUrls: {
                ...wallet === null || wallet === void 0 ? void 0 : wallet.downloadUrls,
            },
    ...
    return (jsx(PageContent, { style: { width: 312 }, children: mobile ? (jsxs(Fragment, { children: [jsx(MobileConnectorsContainer, { children: connectors.map((connector) => {
                        ...
                        if (isInjectedConnector(info.id)) {
                            ...
                            if (injected.wallet) {
                                ...
                                name = (_c = injected.wallet.shortName) !== null && _c !== void 0 ? _c : injected.wallet.name;
                            }
                        }
                        if (isWalletConnectConnector(info.id)) {
                            name =
                                (_e = (_d = context.options) === null || _d === void 0 ? void 0 : _d.walletConnectName) !== null && _e !== void 0 ? _e : locales.otherWallets;
                        }
                        return (jsxs(MobileConnectorButton, { disabled: context.route !== routes.CONNECTORS, onClick: () => {
                                if (isInjectedConnector(info.id) ||
                            ...
                            }, children: [jsx(MobileConnectorIcon, { children: (_h = (_g = (_f = logos.mobile) !== null && _f !== void 0 ? _f : logos.appIcon) !== null && _g !== void 0 ? _g : logos.connectorButton) !== null && _h !== void 0 ? _h : logos.default }), jsx(MobileConnectorLabel, { children: name })] }, `m-${connector.id}`));
                        ...
                        if (!connector.ready && injected.enabled) {
                            return (jsx(Tooltip, { xOffset: 18, message: jsxs("div", { style: { width: 230, padding: '6px 4px' }, children: [name, " Unavailable as ", injected.wallet.name, " is installed. Disable ", injected.wallet.name, " to connect with ", name, "."] }), delay: 0, children: jsxs(ConnectorButton, { disabled: true, children: [jsx(ConnectorIcon, { children: logo }), jsxs(ConnectorLabel, { children: [name, !((_e = context.options) === null || _e === void 0 ? void 0 : _e.hideRecentBadge) &&
                        ...
                        return (jsxs(ConnectorButton, { disabled: context.route !== routes.CONNECTORS, onClick: () => {
                                context.setRoute(routes.CONNECT);
                                context.setConnector(connector.id);
                            }, children: [jsx(ConnectorIcon, { children: logo }), jsxs(ConnectorLabel, { children: [name, !((_f = context.options) === null || _f === void 0 ? void 0 : _f.hideRecentBadge) &&
                                            lastConnectorId === connector.id && (jsx(ConnectorRecentlyUsed, { children: jsx("span", { children: "Recent" }) }))] })] }, connector.id));
...
const ConnectWithInjector = ({ connectorId, switchConnectMethod, forceState }) => {
    ...
    const wallets = useDefaultWallets();
    const installedWallets = wallets.filter((wallet) => wallet.installed);
    let connector = supportedConnectors$1.filter((c) => c.id === id)[0];
    ...
    const suggestedExtension = connector.extensions
        ? {
            ...
            label: ((_a = Object.keys(connector.extensions)[0]) === null || _a === void 0 ? void 0 : _a.charAt(0).toUpperCase()) +
                ((_b = Object.keys(connector.extensions)[0]) === null || _b === void 0 ? void 0 : _b.slice(1)),
    ...
    const locales = useLocales({
        CONNECTORNAME: connector.name,
        CONNECTORSHORTNAME: (_c = connector.shortName) !== null && _c !== void 0 ? _c : connector.name,
        SUGGESTEDEXTENSIONBROWSER: (_d = suggestedExtension === null || suggestedExtension === void 0 ? void 0 : suggestedExtension.label) !== null && _d !== void 0 ? _d : 'your browser',
    });
    const runConnect = () => {
...
const ConnectWithQRCode = ({ connectorId }) => {
    ...
    (connectorInfo === null || connectorInfo === void 0 ? void 0 : connectorInfo.extensions)
        ? {
            ...
            label: ((_a = Object.keys(connectorInfo === null || connectorInfo === void 0 ? void 0 : connectorInfo.extensions)[0]) === null || _a === void 0 ? void 0 : _a.charAt(0).toUpperCase()) +
                ((_b = Object.keys(connectorInfo === null || connectorInfo === void 0 ? void 0 : connectorInfo.extensions)[0]) === null || _b === void 0 ? void 0 : _b.slice(1)),
    ...
    return (jsxs(PageContent, { children: [jsxs(ModalContent, { style: { paddingBottom: 8, gap: 14 }, children: [jsx(CustomQRCode, { value: uri, image: connectorInfo === null || connectorInfo === void 0 ? void 0 : connectorInfo.logos.qrCode, imageBackground: connectorInfo === null || connectorInfo === void 0 ? void 0 : connectorInfo.logoBackground, tooltipMessage: isWalletConnectConnector(connectorId) ? (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, {}), jsx("span", { children: locales.scanScreen_tooltip_walletConnect })] })) : (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, { logo: connectorInfo === null || connectorInfo === void 0 ? void 0 : connectorInfo.logos.connectorButton }), jsx("span", { children: locales.scanScreen_tooltip_default })] })) }), showAdditionalOptions ? (jsx(OrDivider, {})) : (hasApps && jsx(OrDivider, { children: locales.dontHaveTheApp }))] }), showAdditionalOptions && ( // for walletConnect
            jsxs("div", { style: {
                    ...
                    justifyContent: 'center',
                    gap: 14,
                }, children: [((_c = context.options) === null || _c === void 0 ? void 0 : _c.walletConnectCTA) !== 'modal' && (jsx(CopyToClipboard, { variant: "button", string: uri, children: ((_d = context.options) === null || _d === void 0 ? void 0 : _d.walletConnectCTA) === 'link'
                            ? locales.copyToClipboard
                            : locales.copyCode })), ((_e = context.options) === null || _e === void 0 ? void 0 : _e.walletConnectCTA) !== 'link' && (jsx(Button, { icon: jsx(ExternalLinkIcon, {}), onClick: openW3M, disabled: isOpenW3M, waiting: isOpenW3M, children: ((_f = context.options) === null || _f === void 0 ? void 0 : _f.walletConnectCTA) === 'modal'
...
const ChainSelectList = ({ variant, }) => {
    ...
    const { isLoading, pendingChainId, switchNetwork, error } = useSwitchNetwork();
    const locales = useLocales({});
    const mobile = isMobile();
...
const CONNECTKIT_VERSION = '1.5.3';

export { Avatar, CONNECTKIT_VERSION, Chain as ChainIcon, ConnectKitButton, ConnectModal as ConnectKitModalDemo, ConnectKitProvider, Context, SIWEButtonComponent as SIWEButton, SIWEProvider, types as Types, defaultConfig as getDefaultConfig, defaultConnectors as getDefaultConnectors, supportedConnectors$1 as supportedConnectors, useChains, useIsMounted, useModal, useSIWE };
